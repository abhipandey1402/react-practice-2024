...
import autoCompleteTypeahead from '../../../src/images/autoCompletedTypeAhead.png'
...
const AutoCompleteTypeahead = () => {
  ...
  return (
    <Box>
      ...
      <img className='mainImg' src={autoCompleteTypeahead} />
      <Content>AutoCompleteTypeahead</Content>
    </Box>
  )
}
