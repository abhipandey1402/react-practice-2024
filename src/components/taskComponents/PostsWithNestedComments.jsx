...
import postWithNestedComments from '../../../src/images/postWithNestedComments.png'
...
const PostWithNestedComments = () => {
  ...
  return (
    <Box>
      ...
      <img className='mainImg' src={postWithNestedComments} />
      <Content>PostWithNestedComments</Content>
    </Box>
  )
}
